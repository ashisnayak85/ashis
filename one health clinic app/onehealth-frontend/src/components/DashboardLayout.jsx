...
/**
 * The sidebar shell for the Owner / Clinic-Admin / Doctor portals. Overlay
 * drawer on every screen size - hidden by default, opened via the hamburger
 * button in the top Navbar.
 */
