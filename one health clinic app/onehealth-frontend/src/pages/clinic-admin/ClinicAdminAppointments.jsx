...
import { getAppointments, updateAppointmentStatus, cancelAppointment } from "../../api/clinicAdmin";
      ...
      {loading ? (
        ...
        <div className="table-wrap">
          <table className="data-table">
            <thead>
              <tr><th>Time</th><th>Patient</th><th>Doctor</th><th>Source</th><th>Status</th><th></th></tr>
            </thead>
            <tbody>
              {appointments.map((a) => (
                <tr key={a.id}>
                  <td>{a.startTime}</td>
                  <td>{a.patientName}{a.patientPhone ? ` (${a.patientPhone})` : ""}</td>
                  <td>{a.doctorName}</td>
